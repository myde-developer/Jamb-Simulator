...
function renderSubjects() {
    ...
    for (const [key, category] of Object.entries(categories)) {
        ...
        category.subjects.forEach(subject => {
            ...
            html += `
                <div class="subject-card ${isSelected ? 'selected' : ''}" data-id="${subject.id}" data-name="${subject.name}" data-code="${subject.code}" data-mandatory="${subject.mandatory || false}">
...
function startExam() {
    ...
    const hasEnglish = selectedSubjects.some(s => s.name === 'Use of English');
    if (!hasEnglish) {
