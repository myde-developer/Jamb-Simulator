...
-- Topics: Organic Chemistry , Inorganic Chemistry , Physical, Analytical, Electrochemistry
-- ============================================
...
(4, 'Calculate the pH of a 0.01 M HCl solution.',
 '2', '1', '3', '4', 'A',
 'HCl is strong acid, completely dissociated. [H⁺] = 0.01 M = 10⁻² M. pH = -log(10⁻²) = 2.', 'Acids and Bases', 'easy'),
...
(4, 'Which of the following has the highest boiling point?',
 ...
 'Ethanol has hydrogen bonding, strongest intermolecular force among these.', 'Organic Chemistry  Chemistry', 'medium'),

(4, 'Calculate the oxidation state of Cr in K₂Cr₂O₇.',
 '+6', '+3', '+4', '+5', 'A',
 'K: +1 each (total +2), O: -2 each (total -14). So 2(+1) + 2x + 7(-2) = 0 → 2 + 2x -14 = 0 → 2x = 12 → x = +6.', 'Inorganic Chemistry ', 'medium'),

(4, 'How many isomers does C₄H₁₀O have?',
 '7', '4', '5', '6', 'A',
 'Alcohols: butan-1-ol, butan-2-ol, 2-methylpropan-1-ol, 2-methylpropan-2-ol (4 alcohols). Ethers: methoxypropane, ethoxyethane, methoxyisopropane (3 ethers). Total 7.', 'Organic Chemistry ', 'hard'),

(4, 'In the reaction: 2A + B → C, if the rate law is rate = k[A][B]², what is the overall order?',
 '3', '1', '2', '4', 'A',
 'Overall order = sum of exponents = 1 + 2 = 3.', 'Physical Chemistry Chemistry', 'easy'),
...
(4, 'What is the hybridization of carbon in methane (CH₄)?',
 'sp³', 'sp²', 'sp', 'dsp²', 'A',
 'Tetrahedral geometry requires sp³ hybridization.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of these is an aromatic compound?',
 ...
 'Benzene has aromatic ring with conjugated π system.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which gas is evolved when sodium reacts with ethanol?',
 ...
 'Sodium displaces hydrogen from the -OH group of ethanol.', 'Organic Chemistry ', 'medium'),

(4, 'What is the IUPAC name for CH₃CH₂CH₂OH?',
 'Propan-1-ol', 'Propan-2-ol', 'Propanol', 'Propyl alcohol', 'A',
 'Three carbons with -OH on first carbon: propan-1-ol.', 'Organic Chemistry ', 'medium'),

(4, 'Calculate the pH of a 0.001 M NaOH solution.',
 '11', '3', '10', '12', 'A',
 '[OH⁻] = 0.001 = 10⁻³ M, pOH = 3, pH = 14 - 3 = 11.', 'Acids and Bases', 'medium'),

(4, 'Which of these is a strong acid?',
 'HCl', 'CH₃COOH', 'H₂CO₃', 'H₃PO₄', 'A',
 'HCl completely dissociates in water; others are weak acids.', 'Acids and Bases', 'easy'),

(4, 'What is the oxidation state of sulfur in H₂SO₄?',
 '+6', '+4', '+2', '0', 'A',
 'H: +1 each (total +2), O: -2 each (total -8). So 2 + x -8 = 0 → x = +6.', 'Inorganic Chemistry ', 'medium'),

(4, 'Which functional group is present in aldehydes?',
 '-CHO', '-COOH', '-OH', '-CO-', 'A',
 'Aldehydes have carbonyl group with H attached: -CHO.', 'Organic Chemistry ', 'easy')
 (4, 'The shape of XeF₄ molecule is:',
 'Square planar', 'Tetrahedral', 'See-saw', 'Trigonal bipyramidal', 'A',
 'XeF₄ has 6 electron pairs (4 bonding + 2 lone pairs) → square planar geometry.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'Which of the following is not a colligative property?',
 ...
 'Viscosity depends on nature of solute and solvent, not number of particles.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'The hybridization of nitrogen in NH₃ is:',
 'sp³', 'sp²', 'sp', 'sp³d', 'A',
 'Nitrogen has 3 bonding pairs and 1 lone pair → tetrahedral electron geometry, trigonal pyramidal molecular shape, sp³ hybridization.', 'Inorganic Chemistry ', 'easy'),

(4, 'In the Haber process, the catalyst used is:',
 'Finely divided iron', 'Platinum', 'Nickel', 'Vanadium pentoxide', 'A',
 'Fe with promoters (K₂O, Al₂O₃) is used to synthesize ammonia from N₂ and H₂.', 'Inorganic Chemistry ', 'medium'),

(4, 'Which compound shows optical isomerism?',
 '2-butanol', '1-propanol', 'Ethanol', 'Methanol', 'A',
 '2-Butanol has a chiral carbon (four different groups attached).', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following has the highest lattice energy?',
 'MgO', 'NaCl', 'KBr', 'CsI', 'A',
 'Lattice energy increases with higher charge and smaller ionic radii (Mg²⁺ and O²⁻ have high charges and small sizes).', 'Physical Chemistry Chemistry', 'hard'),
...
(4, 'The reaction CH₃COOH + CH₃CH₂OH ⇌ CH₃COOCH₂CH₃ + H₂O is an example of:',
 ...
 'Carboxylic acid + alcohol → ester + water (acid-catalyzed esterification).', 'Organic Chemistry ', 'easy'),
...
(4, 'The IUPAC name of CH₃CH=CHCHO is:',
 ...
 'Four carbons, double bond between 2–3, aldehyde at position 1 → but-2-enal.', 'Organic Chemistry ', 'medium'),

(4, 'Which element shows the highest electronegativity?',
 'Fluorine', 'Oxygen', 'Nitrogen', 'Chlorine', 'A',
 'Fluorine has the highest electronegativity (4.0 on Pauling scale).', 'Inorganic Chemistry ', 'easy'),

(4, 'The half-life of a first-order reaction is 10 minutes. What fraction of reactant remains after 30 minutes?',
 '1/8', '1/4', '1/2', '1/16', 'A',
 'Number of half-lives = 30/10 = 3 → fraction left = (1/2)³ = 1/8.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following is a greenhouse gas?',
 'CO₂', 'N₂', 'O₂', 'Ar', 'A',
 'Carbon dioxide absorbs infrared radiation and contributes to global warming.', 'Physical/Inorganic Chemistry ', 'easy'),

(4, 'The compound with formula C₆H₅COCH₃ is:',
 'Acetophenone', 'Benzaldehyde', 'Benzophenone', 'Benzyl alcohol', 'A',
 'Phenyl methyl ketone → acetophenone.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following is used as an antiseptic?',
 ...
 'Iodoform and dilute ethanol (spirit) are used as antiseptics.', 'Organic Chemistry ', 'easy'),
...
(4, 'The van der Waals equation corrects for:',
 ...
 'van der Waals: (P + a/V²)(V – b) = RT', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which ion is diamagnetic?',
 'Cu⁺', 'Fe³⁺', 'Mn²⁺', 'Co²⁺', 'A',
 'Cu⁺ (d¹⁰) has no unpaired electrons → diamagnetic.', 'Inorganic Chemistry ', 'hard'),

(4, 'The functional group in carboxylic acids is:',
 '-COOH', '-CHO', '-CO-', '-OH', 'A',
 'Carboxyl group: -COOH.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following exhibits geometric isomerism?',
 ...
 'But-2-ene has cis and trans isomers due to restricted rotation around C=C.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which gas turns lime water milky?',
 'CO₂', 'SO₂', 'NO₂', 'H₂', 'A',
 'CO₂ + Ca(OH)₂ → CaCO₃ (white ppt) + H₂O.', 'Inorganic Chemistry ', 'easy'),

(4, 'The compound CH₃CH₂OCH₂CH₃ is:',
 'Diethyl ether', 'Ethyl methyl ether', 'Dimethyl ether', 'Ethoxyethane', 'A',
 'Common name: diethyl ether; IUPAC: ethoxyethane.', 'Organic Chemistry ', 'easy'),
...
(4, 'The Le Chatelier’s principle predicts that increasing pressure on N₂ + 3H₂ ⇌ 2NH₃ will:',
 ...
 '4 moles gas → 2 moles → pressure increase shifts to fewer moles (forward).', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following is used as a drying agent for ammonia gas?',
 'Quicklime (CaO)', 'Conc. H₂SO₄', 'Anhydrous CaCl₂', 'P₄O₁₀', 'A',
 'CaO absorbs water but does not react with NH₃.', 'Inorganic Chemistry ', 'medium'),

(4, 'The monomer of PVC is:',
 'Vinyl chloride', 'Ethene', 'Styrene', 'Tetrafluoroethene', 'A',
 'Poly(vinyl chloride) from CH₂=CHCl.', 'Organic Chemistry ', 'easy'),
...
(4, 'The reaction of alkene with cold alkaline KMnO₄ gives:',
 ...
 'Syn-dihydroxylation (Baeyer’s reagent).', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following is a buffer solution?',
 ...
 'Weak acid + its salt → acidic buffer.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'The IUPAC name of CH₃COCH₂CH₃ is:',
 'Butan-2-one', 'Butanone', 'Propanone', 'Methyl ethyl ketone', 'A',
 'Four carbons, ketone at position 2 → butan-2-one.', 'Organic Chemistry ', 'easy'),

(4, 'Which metal is extracted by the Hall-Héroult process?',
 'Aluminium', 'Iron', 'Copper', 'Zinc', 'A',
 'Electrolysis of alumina dissolved in cryolite.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The activation energy of a reaction can be determined from:',
 ...
 'k = A e^(-Ea/RT) → plot ln k vs 1/T gives Ea.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which compound gives iodoform test?',
 'Ethanol', 'Acetone', 'Acetaldehyde', 'All of the above', 'D',
 'Compounds with CH₃CH(OH)- or CH₃CO- group give yellow ppt with I₂/NaOH.', 'Organic Chemistry ', 'medium'),

(4, 'The most stable oxidation state of manganese is:',
 '+2', '+7', '+4', '+6', 'A',
 'Mn²⁺ is most stable in aqueous solution.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'In SN1 reaction, the rate depends on:',
 ...
 'Unimolecular – rate = k [RX].', 'Organic Chemistry ', 'medium'),
...
(4, 'The SI unit of electric conductance is:',
 ...
 'H₂S', 'SO₂', 'NH₃', 'CH₄', 'A',
 'Hydrogen sulfide (H₂S) has a characteristic rotten egg odor.', 'Inorganic Chemistry ', 'easy'),

(4, 'Which of the following is a secondary alcohol?',
 'Propan-2-ol', 'Propan-1-ol', 'Ethanol', '2-Methylpropan-2-ol', 'A',
 'Secondary alcohol has the -OH group attached to a carbon bonded to two other carbons.', 'Organic Chemistry ', 'easy'),
...
(4, 'The common ion effect suppresses the ionization of a weak electrolyte when:',
 ...
 'Adding a common ion shifts equilibrium left (Le Chatelier’s principle).', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which metal reacts with steam but not with cold water?',
 'Magnesium', 'Sodium', 'Potassium', 'Calcium', 'A',
 'Mg reacts slowly with steam to form MgO and H₂; alkali metals react vigorously with cold water.', 'Inorganic Chemistry ', 'medium'),

(4, 'The monomer of Teflon is:',
 'Tetrafluoroethene', 'Vinyl chloride', 'Styrene', 'Ethene', 'A',
 'Polytetrafluoroethylene (PTFE) from CF₂=CF₂.', 'Organic Chemistry ', 'medium'),

(4, 'In Kjeldahl’s method, nitrogen is estimated by converting it to:',
 'Ammonium sulfate', 'Ammonia', 'Nitric acid', 'Nitrogen gas', 'B',
 'Organic Chemistry  compound → NH₃ → absorbed in H₂SO₄ as (NH₄)₂SO₄, then distilled and titrated.', 'Analytical', 'medium'),
...
(4, 'Which of the following shows tautomerism?',
 ...
 'Keto-enol tautomerism in acetone (CH₃COCH₃ ⇌ CH₂=C(OH)CH₃).', 'Organic Chemistry ', 'medium'),
...
(4, 'The solubility product (Ksp) of sparingly soluble salt is:',
 ...
 'For AB ⇌ A⁺ + B⁻, Ksp = [A⁺][B⁻].', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which gas is used in the manufacture of soda lime?',
 'CO₂', 'NH₃', 'Cl₂', 'SO₂', 'A',
 'Ca(OH)₂ + CO₂ → CaCO₃ + H₂O (soda lime production).', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The reaction CH₄ + Cl₂ → CH₃Cl + HCl (in sunlight) is an example of:',
 ...
 'Initiation, propagation, termination steps with chlorine radicals.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which element has the highest first ionization energy?',
 ...
 'He has the smallest size and highest effective nuclear charge among these.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'In Cannizzaro reaction, the aldehyde that undergoes it must have:',
 ...
 'Aldehydes without α-H (e.g., benzaldehyde, formaldehyde) undergo disproportionation.', 'Organic Chemistry ', 'hard'),
...
(4, 'Which of the following is a lyophilic colloid?',
 ...
 'Lyophilic colloids (solvent-loving) are stable and reversible (e.g., starch, gelatin).', 'Physical Chemistry Chemistry', 'medium'),

(4, 'The IUPAC name of CH₃CH(OH)CH₂CH₃ is:',
 'Butan-2-ol', 'Butan-1-ol', '2-Butanol', 'sec-Butyl alcohol', 'A',
 'Four-carbon chain, -OH on carbon 2 → butan-2-ol.', 'Organic Chemistry ', 'easy'),

(4, 'Which compound is used as a refrigerant in domestic refrigerators?',
 'Freon (CCl₂F₂)', 'Ammonia', 'CO₂', 'SO₂', 'A',
 'Chlorofluorocarbons (CFCs) like Freon-12 were widely used (now phased out).', 'Organic Chemistry /Inorganic Chemistry ', 'medium'),
...
(4, 'The order of a reaction can be determined by:',
 ...
 'Integrated rate laws give straight lines for different orders.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following is an example of interstitial compound?',
 'Steel (Fe + C)', 'Brass (Cu + Zn)', 'Bronze (Cu + Sn)', 'Solder (Pb + Sn)', 'A',
 'Small atoms (C, H, N) occupy interstitial sites in metal lattice.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'Which alkene on ozonolysis gives only one product (acetone)?',
 ...
 '(CH₃)₂C=CH₂ → 2 (CH₃)₂C=O.', 'Organic Chemistry ', 'hard'),
...
(4, 'Which of the following has maximum dipole moment?',
 'NH₃', 'NF₃', 'BF₃', 'CH₄', 'A',
 'NH₃ has a significant dipole due to lone pair on N; NF₃ has opposing effects but smaller net dipole.', 'Physical/Inorganic Chemistry ', 'hard'),

(4, 'The reaction of Grignard reagent with CO₂ followed by hydrolysis gives:',
 'Carboxylic acid', 'Alcohol', 'Aldehyde', 'Ketone', 'A',
 'RMgX + CO₂ → RCOOMgX → RCOOH.', 'Organic Chemistry ', 'medium'),

(4, 'The unit of rate constant for a third-order reaction is:',
 'L² mol⁻² s⁻¹', 'L mol⁻¹ s⁻¹', 'mol L⁻¹ s⁻¹', 's⁻¹', 'A',
 'Rate = k [A]³ → k = rate / [A]³ → units: mol L⁻¹ s⁻¹ / (mol L⁻¹)³ = L² mol⁻² s⁻¹.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following is used to absorb CO₂ in respiration experiments?',
 'KOH', 'NaOH', 'Ca(OH)₂', 'All of the above', 'D',
 'Potassium hydroxide is commonly used in soda lime or as solution.', 'Inorganic Chemistry ', 'easy'),

(4, 'The compound CH₃COCH₃ is:',
 'Acetone', 'Acetaldehyde', 'Acetic acid', 'Ethyl methyl ketone', 'A',
 'Dimethyl ketone → acetone (propan-2-one).', 'Organic Chemistry ', 'easy'),
...
(4, 'Which halogen forms interhalogen compound with lowest boiling point?',
 ...
 'Interhalogens like ClF, BrF₃; fluorine compounds often more volatile.', 'Inorganic Chemistry ', 'hard'),

(4, 'The electrophile in Friedel-Crafts acylation is:',
 'CH₃CO⁺ (acylium ion)', 'CH₃⁺', 'AlCl₃', 'Cl⁻', 'A',
 'AlCl₃ + CH₃COCl → CH₃CO⁺ + AlCl₄⁻.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following is an example of chain growth polymer?',
 ...
 'Addition polymerization (e.g., ethene → polyethene).', 'Organic Chemistry ', 'medium'),

(4, 'The color of KMnO₄ in acidic medium disappears due to reduction to:',
 'Mn²⁺ (colorless)', 'MnO₂ (brown)', 'MnO₄²⁻ (green)', 'Mn³⁺ (red)', 'A',
 'MnO₄⁻ (purple) → Mn²⁺ (very pale pink/almost colorless) in acidic medium.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The compound with formula C₆H₅CHO is:',
 ...
 'Benzene carbaldehyde → benzaldehyde.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which factor does NOT affect the rate of a heterogeneous reaction?',
 ...
 'Solids have constant concentration; rate depends on surface area instead.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'The alloy used for making permanent magnets is:',
 'Alnico', 'Brass', 'Bronze', 'Solder', 'A',
 'Alnico contains Al, Ni, Co, Fe.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'In Reimer-Tiemann reaction, phenol reacts with CHCl₃ in presence of NaOH to give:',
 ...
 'Ortho-hydroxybenzaldehyde (salicylaldehyde) is the main product.', 'Organic Chemistry ', 'hard'),
...
(4, 'Which of the following shows the highest lattice energy?',
 'LiF', 'NaCl', 'KBr', 'RbI', 'A',
 'Smallest ions with highest charges give highest lattice energy (Li⁺ and F⁻).', 'Physical Chemistry Chemistry', 'medium'),

(4, 'The IUPAC name of CH₃CH₂COCH₃ is:',
 'Butan-2-one', 'Propanone', 'Butanone', 'Methyl ethyl ketone', 'A',
 'CH₃CH₂COCH₃ = four carbons, ketone at position 2.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which process is used for large-scale production of sulfuric acid?',
 ...
 'Contact process: SO₂ → SO₃ (V₂O₅ catalyst) → H₂SO₄.', 'Inorganic Chemistry ', 'medium'),

(4, 'The half-life of a radioactive isotope is 2 hours. What fraction remains after 6 hours?',
 '1/8', '1/4', '1/2', '1/16', 'A',
 '3 half-lives → (1/2)³ = 1/8.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which functional group gives positive FeCl₃ test (violet color)?',
 'Phenols', 'Alcohols', 'Aldehydes', 'Ketones', 'A',
 'Enolic form of phenols complexes with Fe³⁺.', 'Organic Chemistry ', 'medium'),
...
(4, 'The element with atomic number 26 is:',
 ...
 'Fe (Z=26).', 'Inorganic Chemistry ', 'easy'),
...
(4, 'Which of the following is an example of nucleophilic addition reaction?',
 ...
 'Carbonyl compounds undergo nucleophilic addition (e.g., cyanohydrin formation).', 'Organic Chemistry ', 'medium'),

(4, 'The salt that gives acidic solution in water is:',
 'NH₄Cl', 'Na₂CO₃', 'KCl', 'NaCH₃COO', 'A',
 'NH₄⁺ hydrolyzes to give H⁺ (from weak base NH₃ + strong acid HCl).', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which gas is liberated when dilute H₂SO₄ is added to zinc?',
 'Hydrogen', 'Oxygen', 'Sulfur dioxide', 'Carbon dioxide', 'A',
 'Zn + H₂SO₄ → ZnSO₄ + H₂.', 'Inorganic Chemistry ', 'easy')
 (4, 'The compound CH₃CH₂CH₂COOH is named:',
 'Butanoic acid', 'Propanoic acid', 'Butyric acid', 'Both A and C', 'D',
 'IUPAC: butanoic acid; common name: butyric acid.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following is used as an oxidizing agent in the preparation of aldehydes from alcohols?',
 ...
 'PCC selectively oxidizes primary alcohols to aldehydes without further oxidation.', 'Organic Chemistry ', 'medium'),
...
(4, 'The colligative property that depends on the number of particles is:',
 ...
 'Relative lowering of vapour pressure, boiling point elevation, freezing point depression, and osmotic pressure all depend on particle number.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following elements forms the maximum number of oxides?',
 'Nitrogen', 'Phosphorus', 'Sulfur', 'Chlorine', 'A',
 'Nitrogen forms N₂O, NO, N₂O₃, NO₂, N₂O₅ (five oxides).', 'Inorganic Chemistry ', 'medium'),

(4, 'The reaction of ethene with bromine water gives:',
 '1,2-Dibromoethane', 'Bromoethane', 'Ethanol', 'Ethyl bromide', 'A',
 'Br₂ adds across the double bond → vicinal dibromide (anti addition).', 'Organic Chemistry ', 'easy'),
...
(4, 'Which compound does NOT show stereoisomerism?',
 ...
 '2-Methylpropane (isobutane) has no chiral center or double bond for cis-trans.', 'Organic Chemistry ', 'medium'),

(4, 'The pH of 10⁻⁸ M HCl solution is approximately:',
 '6.98', '7.00', '8.00', '2.00', 'A',
 'Very dilute strong acid: [H⁺] from HCl ≈ 10⁻⁸, from water 10⁻⁷ → total [H⁺] ≈ 1.1 × 10⁻⁷ → pH ≈ 6.96–7.0.', 'Physical Chemistry Chemistry', 'hard'),

(4, 'Which of the following is a reducing agent?',
 'NaH', 'KMnO₄', 'K₂Cr₂O₇', 'HNO₃ (conc.)', 'A',
 'Sodium hydride (NaH) donates hydride ion (H⁻), strong reducing agent.', 'Inorganic Chemistry ', 'medium'),

(4, 'The reaction C₂H₅Br + KOH (alc.) → C₂H₄ + KBr + H₂O is:',
 'Elimination (E2)', 'Substitution (SN2)', 'Substitution (SN1)', 'Addition', 'A',
 'Alcoholic KOH → dehydrohalogenation → alkene (β-elimination).', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following has the highest bond dissociation energy?',
 'H–F', 'H–Cl', 'H–Br', 'H–I', 'A',
 'Bond strength decreases down the group due to increasing size → H–F strongest.', 'Inorganic Chemistry /Physical', 'medium'),

(4, 'The compound that gives positive Tollens’ test is:',
 'Aldehydes', 'Ketones', 'Carboxylic acids', 'Esters', 'A',
 'Tollens’ reagent (ammoniacal AgNO₃) oxidizes aldehydes to carboxylic acids, depositing silver mirror.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following is a condensation polymer?',
 ...
 'Nylon-6,6 from hexamethylenediamine + adipic acid (condensation with loss of H₂O).', 'Organic Chemistry ', 'medium'),

(4, 'The IUPAC name of CH₃CH=CHCOOH is:',
 'But-2-enoic acid', 'Butenoic acid', 'Crotonic acid', 'Both A and C', 'D',
 'IUPAC: but-2-enoic acid; common: crotonic acid.', 'Organic Chemistry ', 'medium'),

(4, 'Which gas is evolved when ammonium dichromate is heated?',
 'Nitrogen', 'Oxygen', 'Ammonia', 'Nitrous oxide', 'A',
 '(NH₄)₂Cr₂O₇ → Cr₂O₃ + N₂ + 4H₂O (volcano experiment).', 'Inorganic Chemistry ', 'easy'),
...
(4, 'The rate of a reaction increases with temperature because:',
 ...
 'Higher temperature increases kinetic energy → more molecules exceed Ea.', 'Physical Chemistry Chemistry', 'easy'),

(4, 'Which of the following is used in the test for unsaturation?',
 'Bromine water', 'Baeyer’s reagent', 'Both A and B', 'KMnO₄ (acidic)', 'C',
 'Decolorization of Br₂ water or cold alkaline KMnO₄ indicates unsaturation.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which element exhibits +7 oxidation state most commonly?',
 'Manganese', 'Chlorine', 'Iodine', 'Fluorine', 'A',
 'Manganese in KMnO₄ (MnO₄⁻) shows +7 oxidation state most commonly; chlorine shows +7 but less commonly.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The compound CH₃COOC₂H₅ is:',
 ...
 'IUPAC: ethyl ethanoate; common: ethyl acetate.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following is an example of auto-catalysis?',
 ...
 'Mn²⁺ produced acts as catalyst in acidic KMnO₄ + oxalic acid reaction.', 'Physical Chemistry Chemistry', 'hard'),

(4, 'The alloy used for making heating elements is:',
 'Nichrome', 'Brass', 'Bronze', 'Duralumin', 'A',
 'Ni + Cr alloy has high resistance and melting point.', 'Inorganic Chemistry ', 'easy'),
...
(4, 'Which reaction is used to convert alkyl halide to nitrile?',
 ...
 'RX + KCN (or NaCN) → RCN + KX (SN2).', 'Organic Chemistry ', 'medium'),
...
(4, 'The equivalent conductance at infinite dilution (Λ°) is:',
 ...
 'Kohlrausch’s law: Λ° = λ°cation + λ°anion.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which gas is used for ripening of fruits?',
 'Ethene (ethylene)', 'Acetylene', 'Methane', 'Carbon monoxide', 'A',
 'Ethylene (C₂H₄) is a natural plant hormone for fruit ripening.', 'Organic Chemistry ', 'easy'),

(4, 'In flame test, potassium gives:',
 'Violet color', 'Brick red', 'Green', 'Yellow', 'A',
 'K⁺ gives violet (lilac) flame.', 'Analytical/Inorganic Chemistry ', 'easy'),

(4, 'The compound that undergoes haloform reaction is:',
 'Acetaldehyde', 'Acetone', 'Ethyl methyl ketone', 'All of the above', 'D',
 'Compounds with CH₃CO– or CH₃CH(OH)– group give haloform with X₂/NaOH.', 'Organic Chemistry ', 'medium'),
...
(4, 'The process used for concentration of sulphide ores is:',
 ...
 'Sulphide ores are preferentially wetted by oil → froth flotation.', 'Inorganic Chemistry ', 'medium'),

(4, 'Which of the following has sp² hybridization?',
 'Ethene carbon', 'Methane carbon', 'Acetylene carbon', 'Ammonia nitrogen', 'A',
 'C=C bond in ethene: sp² hybridized carbons.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which compound is used in perfume industry?',
 ...
 'Many esters (fruity), aldehydes (floral), and some ketones have pleasant odors.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following is a metalloid?',
 ...
 'Si, Ge, As show properties intermediate between metals and non-metals.', 'Inorganic Chemistry ', 'easy'),
...
(4, 'The reaction mechanism of SN2 is:',
 ...
 'Bimolecular nucleophilic substitution → concerted, inversion.', 'Organic Chemistry ', 'medium'),
...
(4, 'The boiling point of water at high altitude is lower because:',
 ...
 'Lower external pressure → lower boiling point.', 'Physical Chemistry Chemistry', 'easy'),

(4, 'Which element is used in making transistors?',
 'Silicon', 'Germanium', 'Both A and B', 'Gallium', 'C',
 'Si and Ge are semiconductors used in transistors.', 'Inorganic Chemistry ', 'medium'),

(4, 'The compound CH₃NH₂ is:',
 'Methylamine', 'Ethylamine', 'Aniline', 'Dimethylamine', 'A',
 'CH₃NH₂ → methylamine (primary amine).', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following is an example of lyophobic colloid?',
 ...
 'Lyophobic colloids (solvent-repelling) are irreversible and less stable.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'The IUPAC name of (CH₃)₂CHCHO is:',
 '2-Methylpropanal', 'Isobutyraldehyde', 'Both A and B', 'Propanal', 'C',
 'IUPAC: 2-methylpropanal; common: isobutyraldehyde.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which process is used for purification of noble metals?',
 ...
 'Zone refining for ultra-pure semiconductors and noble metals.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The activation energy is:',
 ...
 'Minimum energy barrier reactants must overcome.', 'Physical Chemistry Chemistry', 'easy'),

(4, 'Which test distinguishes between phenol and alcohol?',
 'Ferric chloride test', 'Lucas test', 'Iodoform test', 'Tollens’ test', 'A',
 'Phenol gives violet color with FeCl₃; alcohols do not.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following is a natural polymer?',
 ...
 'Cellulose is a polysaccharide found in plants.', 'Organic Chemistry ', 'easy')
 (4, 'The compound CH₃CH₂OH is:',
 'Ethanol', 'Methanol', 'Propanol', 'Butanol', 'A',
 'Ethyl alcohol (common name); IUPAC: ethanol.', 'Organic Chemistry ', 'easy'),

(4, 'Which of the following is used as a mordant in dyeing?',
 'Alum (KAl(SO₄)₂·12H₂O)', 'NaCl', 'CaCO₃', 'MgSO₄', 'A',
 'Alum helps fix dyes to fabrics by forming insoluble complexes.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The reaction 2H₂ + O₂ → 2H₂O is an example of:',
 ...
 'Two reactants combine to form a single product.', 'Inorganic Chemistry ', 'easy'),

(4, 'Which functional group is present in amides?',
 '-CONH₂', '-COOH', '-CHO', '-NH₂', 'A',
 'Amides have the carbonyl attached to nitrogen: -CONH₂ or -CONHR.', 'Organic Chemistry ', 'easy'),

(4, 'In Ostwald’s process, nitric acid is prepared from:',
 'Ammonia', 'Nitrogen', 'Nitrous oxide', 'Sodium nitrate', 'A',
 '4NH₃ + 5O₂ → 4NO + 6H₂O (Pt catalyst), then NO → NO₂ → HNO₃.', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The colligative property used to determine molecular weight of polymers is:',
 ...
 'Osmotic pressure gives accurate ΔT for large molecules at low concentrations.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following shows maximum paramagnetism?',
 'Mn²⁺', 'Fe³⁺', 'Cu²⁺', 'Zn²⁺', 'B',
 'Fe³⁺ (d⁵) has 5 unpaired electrons in high-spin state.', 'Inorganic Chemistry ', 'hard'),
...
(4, 'The compound C₆H₅COOH is:',
 ...
 'Benzenecarboxylic acid → benzoic acid.', 'Organic Chemistry ', 'easy'),
...
(4, 'In Le Chatelier’s principle, increasing temperature in an exothermic reaction will:',
 ...
 'Heat is treated as a product → shift left to absorb heat.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which metal is extracted by the Mond process?',
 'Nickel', 'Iron', 'Copper', 'Aluminium', 'A',
 'Ni + 4CO → Ni(CO)₄ → Ni + 4CO (purification).', 'Inorganic Chemistry ', 'medium'),
...
(4, 'The reaction of alkene with HBr in presence of peroxide follows:',
 ...
 'Free radical mechanism → H adds to carbon with fewer H atoms.', 'Organic Chemistry ', 'medium'),

(4, 'The unit of specific conductance (κ) is:',
 'S cm⁻¹', 'S cm² mol⁻¹', 'ohm⁻¹ cm⁻¹', 'Both A and C', 'D',
 'Specific conductance = conductance × cell constant → S cm⁻¹.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which of the following is a non-benzenoid aromatic compound?',
 'Tropylium ion', 'Benzene', 'Pyridine', 'Furan', 'A',
 'Tropylium cation (C₇H₇⁺) is 6π-electron aromatic system.', 'Organic Chemistry ', 'hard'),
...
(4, 'The compound that does not give iodoform test is:',
 ...
 'Propanal (CH₃CH₂CHO) lacks CH₃CO– or CH₃CH(OH)– group.', 'Organic Chemistry ', 'medium'),

(4, 'Which process is used for desilverization of lead?',
 'Parkes process', 'Pattinson process', 'Cupellation', 'Both A and B', 'D',
 'Zinc forms Ag-Zn crust (Parkes); cooling separates Ag-Pb (Pattinson).', 'Inorganic Chemistry ', 'hard'),
...
(4, 'The half-life of a second-order reaction is:',
 ...
 't₁/₂ = 1 / (k [A]₀) for second-order.', 'Physical Chemistry Chemistry', 'medium'),

(4, 'Which gas is used in electric discharge tubes for producing different colors?',
 'Neon', 'Argon', 'Helium', 'All of the above', 'D',
 'Noble gases emit characteristic colors under electric discharge.', 'Inorganic Chemistry ', 'easy'),

(4, 'The functional group in esters is:',
 '-COOR', '-COOH', '-CONH₂', '-CHO', 'A',
 'Ester linkage: -COO- between carbonyl and alkoxy group.', 'Organic Chemistry ', 'easy'),
...
(4, 'Which of the following is an example of zero-order reaction?',
 ...
 'Rate independent of concentration when surface is saturated.', 'Physical Chemistry Chemistry', 'hard'),

(4, 'The element with highest electron affinity in periodic table is:',
 'Chlorine', 'Fluorine', 'Bromine', 'Iodine', 'A',
 'Cl has slightly higher electron affinity than F due to less electron repulsion.', 'Inorganic Chemistry ', 'medium'),

(4, 'The compound used as tear gas is:',
 'Benzyl chloride', 'Chloroacetophenone', 'Chloropicrin', 'All of the above', 'D',
 'Common tear gases include CN (chloroacetophenone), CS, etc.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which of the following is a heterocyclic compound?',
 ...
 'Pyridine has nitrogen in the aromatic ring.', 'Organic Chemistry ', 'medium'),
...
(4, 'Which metal is used in thermite process?',
 'Aluminium', 'Iron', 'Copper', 'Zinc', 'A',
 'Al reduces metal oxides (e.g., Fe₂O₃ + 2Al → 2Fe + Al₂O₃).', 'Inorganic Chemistry ', 'medium'),

(4, 'The compound CH₃COCl is:',
 'Acetyl chloride', 'Acetic anhydride', 'Acetamide', 'Acetaldehyde', 'A',
 'Acid chloride of acetic acid.', 'Organic Chemistry ', 'easy');
