...
'Synonyms': 5,
    ...
    // Arts & Humanities
    8: { id: 8, name: 'Literature in English', code: 'LIT', category: 'arts', totalQuestions: 40, duration: 60, topics: ['Drama', 'Prose', 'Poetry', 'Literary Principles', 'Literary Appreciation', 'African Literature', 'Non-African Literature', 'Figures of Speech', 'Literary Criticism'] },
    ...
    14: { id: 14, name: 'Yoruba', code: 'YRB', category: 'arts', totalQuestions: 40, duration: 60, topics: ['Alphabet', 'Grammar', 'Culture', 'History', 'Composition'] },
    15: { id: 15, name: 'Igbo', code: 'IGB', category: 'arts', totalQuestions: 40, duration: 60, topics: ['Alphabet', 'Vocabulary', 'Grammar', 'Culture', 'History'] },
    16: { id: 16, name: 'Hausa', code: 'HAU', category: 'arts', totalQuestions: 40, duration: 60, topics: ['Alphabet', 'Grammar', 'Culture', 'History', 'Writing'] },
